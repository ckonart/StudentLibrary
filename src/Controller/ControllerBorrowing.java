...
public class ControllerBorrowing {
    ...
    public Borrowing borrowBook() {
        ...
        Books book = mybook.searchTitle(title, ControllerBooks.book);

        System.out.print("Enter the name of the student: ");
        String studentName = myKB.nextLine();
        Students student = myStd.searchName(studentName, ControllerStudents.students);
        ...
        System.out.println("This book has been successfully borrowed!");
    ...
    public Borrowing returnBook() {
        ...
        String studentName = myKB.nextLine();
        Students student = meuStd.searchName(studentName, ControllerStudents.students); //code to use method that we already developed in Student class for search the student name
        ...
        String title = myKB.nextLine();
        Books book = meuLivro.searchTitle(title, ControllerBooks.book);  //code to use method that we already developed in Book class for search the book title
        ...
        for (Borrowing Borrowing : listBorrowings) {  //for loop for our list of borrowed books
            if (Borrowing.getStudent().getFirstName() == student.getFirstName() && Borrowing.isAvailable() == false) { //condition to confirm that the book was really borrowed
